            ...
            <?php if ($all_messages->num_rows > 0): ?>
                <?php while($message = $all_messages->fetch_assoc()): ?>
                    <?php 
                        ...
                        $moved_timestamp = date('F j, Y g:i A', strtotime($message['moved_timestamp']));
                        ...
                        <div class="message-wrapper">
                            <div class="message-content">
                                ...
                                <div class="timestamp-container">
                                    <p class="send-to-timestamp-trash">Sent: <?php echo $timestamp; ?></p>
                                    <p class="delete-to-timestamp-trash">
                                        <?php echo $is_deleted ? "Moved to trash: " : "Moved to trash: "; ?>
                                        <?php echo $moved_timestamp; ?>
                                    </p>
                                </div>
