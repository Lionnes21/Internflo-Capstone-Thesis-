<?php
   ...
   // If logged in, fetch user details from the database
    ...
    $messages_query = "SELECT * FROM messaging_sent WHERE sender_email = ? ORDER BY timestamp DESC";
...
<body>
    ...
    <div class="container">
        <nav class="nav">
            ...
            <a href="chat-sent.php" class="nav-item active">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#002b7f"><path d="M176.24-178.7q-22.87 9.44-43.26-3.85-20.39-13.3-20.39-38.17V-393.3l331-86.7-331-86.7v-172.58q0-24.87 20.39-38.17 20.39-13.29 43.26-3.85l613.61 259.28q28.11 12.43 28.11 42.02 0 29.59-28.11 42.02L176.24-178.7Z"/></svg>
                Sent
            </a>
