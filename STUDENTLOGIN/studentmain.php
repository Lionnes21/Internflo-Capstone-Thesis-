<?php
    ...
    if ($isLoggedIn) {
        ...
        $sql = 'SELECT first_name, middle_name, last_name, suffix, email, course, school_year, city, region, postal_code, barangay, home_address, student_id, name, profile_pic FROM students WHERE id = ?';
        ...
        if ($user) {
            $profile_pic = $user['profile_pic'] ?? 'pics/default_profile.jpg';
            ...
            $fullName2 = $fullName; // Create a second variable as requested
        }
    }
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="side-menu" id="firstMenu" style="display: flex;">
            ...
            <div class="bottom-menu-content">
                <hr class="bottomhr">
                <div class="menu-item-bottom" onclick="location.href='studentfrontpage.php'">
                    <svg xmlns="http://www.w3.org/2000/svg" height="28px" viewBox="0 -960 960 960" width="28px" fill="#2e3849">
    ...
    <div id="successOverlay" style="display: none;">
        <div class="success-container">
            ...
            <p style="display: none;" id="scannedText"></p>
    ...
    <div id="main-content">
        <div class="search-container">
            ...
            <?php if ($isLoggedIn): ?>
                <div id="profile-icon">
                    <img src="<?php echo htmlspecialchars($profile_pic, ENT_QUOTES); ?>" alt="Profile" onclick="toggleDropdown()">
                    <div id="dropdown-content">
                        <div class="user-fullname"><?php echo htmlspecialchars($fullName2, ENT_QUOTES); ?></div>
                        <hr class="line">
                ...
                if (navigator.geolocation) {
                    navigator.geolocation.getCurrentPosition(
                        (position) => {
                            ...
                            userIcon.src = "pics/currentloc.png";
