<?php
    ...
    // Fetch internship and company information
    $sql = "SELECT ia.*, ar.company_name, ar.company_logo, ar.company_address 
    ...
    $posted_time = timeAgo($data['created_at']);
?>
...
<head>
    ...
    <link rel="stylesheet" href="internshipad.css">
...
<body>
  ...
  <div class="navbar">
        ...
        <div class="nav-links">
            ...
            <a href="../RECRUITER/companysignin.php" class="employer-btn">EMPLOYER</a>
        </div>
    </div>
    ...
    <div class="alert" >
            <div class="alert__wrapper">
                    ...
                    <p class="alert__message">
                        This internship application requires logging in. Please 
    ...
    <div class="wrapper">
        <div class="container">
            <div class="bgwidth">
                ...
                <div class="details">
                    <div class="detail-item">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#2E3849"><path d="M480-186q122-112 181-203.5T720-552q0-109-69.5-178.5T480-800q-101 0-170.5 69.5T240-552q0 71 59 162.5T480-186Zm0 79q-14 0-28-5t-25-15q-65-60-115-117t-83.5-110.5q-33.5-53.5-51-103T160-552q0-150 96.5-239T480-880q127 0 223.5 89T800-552q0 45-17.5 94.5t-51 103Q698-301 648-244T533-127q-11 10-25 15t-28 5Zm0-453Zm0 80q33 0 56.5-23.5T560-560q0-33-23.5-56.5T480-640q-33 0-56.5 23.5T400-560q0 33 23.5 56.5T480-480Z"/></svg>
                        <span><?php echo htmlspecialchars($data['company_address']); ?></span>
                    </div>
                    ...
                    <div class="detail-item">
                        ...
                        <span><?php echo htmlspecialchars($data['internship_title']); ?> (<?php echo htmlspecialchars($data['department']); ?>)</span>
                    </div>
                    
                    <div class="info-container">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#2E3849"><path d="M520-496v-144q0-17-11.5-28.5T480-680q-17 0-28.5 11.5T440-640v159q0 8 3 15.5t9 13.5l132 132q11 11 28 11t28-11q11-11 11-28t-11-28L520-496ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-400Zm0 320q133 0 226.5-93.5T800-480q0-133-93.5-226.5T480-800q-133 0-226.5 93.5T160-480q0 133 93.5 226.5T480-160Z"/></svg>
                        <span><?php echo htmlspecialchars($data['internship_type']); ?></span>
                        <span class="dot">•</span>
                        <span><?php echo htmlspecialchars($data['duration']); ?> hours</span>
                    </div>
                    ...
                    <div class="detail-item">
                        ...
                        <span><?php echo htmlspecialchars($data['number_of_openings']); ?> available internship spots</span>
                    </div>

                    <div class="posted">Posted <?php echo $posted_time; ?></div>
                </div>
            ...
            <div class="job-content">
                ...
                <h2><?php echo htmlspecialchars($data['internship_title']); ?></h2>
                <p><?php echo nl2br(htmlspecialchars($data['internship_description'])); ?></p>
                
                <h2><?php echo htmlspecialchars($data['internship_title']); ?> Skills</h2>
                <ul>
                    <?php 
                ...
                <h2><?php echo htmlspecialchars($data['internship_title']); ?> Requirements</h2>
                <ul>
                    <?php 
                ...
                <h2><?php echo htmlspecialchars($data['internship_title']); ?> Qualifications</h2>
                <ul>
                    <?php 
                ...
                <div class="calendar">
                    ...
                    <div class="calendar-body">
                        <div class="calendar-day"><?php echo date("d", strtotime($data['application_deadline'])); ?></div>
                        <div class="calendar-month-year">
                            <?php 
                                echo date("F Y", strtotime($data['application_deadline'])); 
                            ?>
                        </div>
                    </div>
                </div>
                ...
                <h2><?php echo htmlspecialchars($data['internship_title']); ?> Summary</h2>
                <p><?php echo nl2br(htmlspecialchars($data['internship_summary'])); ?></p>
                ...
                <ul>
                    ...
                    foreach($additional_info as $info) {
                        if(trim($info)) {
                            echo "<li>" . htmlspecialchars(trim($info)) . "</li>";
                        }
                    }
                    ?>
                </ul>
