    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['send_message'])) {
        ...
        if (!empty($recipient_type)) {
            ...
            try {
                ...
                // Insert into messaging_sent table with the same message_id
            ...
            <?php if ($all_messages->num_rows > 0): ?>
                <?php while($message = $all_messages->fetch_assoc()): ?>
                    <?php 
                        ...
                        // For messaging_inbox table, always display the sender's info with "From:"
                        // For messaging_inbox table, always display the sender's info with "From:"
                        if ($is_inbox) {
                            ...
                            // For other tables (like deleted), keep the original "To:" logic
