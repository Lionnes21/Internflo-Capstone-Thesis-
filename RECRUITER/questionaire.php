...
<head>
    ...
    <title>UCC - Internship Ad Assessment</title>
...
<body>
    ...
    <div class="form-header">
        ...
        <div class="header-content">
            ...
            <input type="text" class="form-description" placeholder="Form Description" maxlength="215">
        </div>
    </div>
    ...
    <div class="note-banner">
        <p class="note-banner-text">
            <span class="note-banner-content">
                ...
                <span class="text">
                Each question type has a specific difficulty level, with a timer based on its complexity and task requirements.</span>
            </span>
        </p>
    </div>
    <div class="banner">
    ...
    <p class="textbelow">Not yet ready for creating assessment for your applicants? <a href="companyloginpage.php">Skip Assessment</a></p>
    ...
    <script>    
        ...
        const formData = {
            ...
            .then(data => {
                if (data.success) {
                    alert(data.message);
                    // Redirect back to createinternship.php
